...
silence ─► endpoint ─► transcript ─► translation ─► first sentence ─► first audio
          ...
          ~600 ms      ~250 ms       ~450 ms        ~55 ms            ~110 ms
```
